...
set CFLAGS=/nologo /W3 /Od /std:c11 /D_CRT_SECURE_NO_WARNINGS /I"%COMMON%" /I"%UNITY%" /TC
...
cl /nologo /Fe:unit_tests.exe ^
  test_main.obj test_md5calc.obj test_utils.obj ^
  stubs\malloc_stub.obj md5calc.obj utils.obj unity.obj
if errorlevel 1 exit /b 1
