...
yuno_pre.gat,96,69,2	script(HIDDEN)	素敵な紳士#Lhz	754,{}
...
lhz_fild02.gat,228,214,7	script(HIDDEN)	負傷した男#Lhz	849,{
	if(LHZ_4QUE > 18)
		end;
	if(LHZ_4QUE < 18) {
		mes "[？？？？]";
...
yuno_pre.gat,77,68,0	script(HIDDEN)	秘書#Lhz	862,{}
...
yuno_pre.gat,75,73,0	script(HIDDEN)	きれいな紳士#Lhz	109,{}
