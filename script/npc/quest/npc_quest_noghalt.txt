...
tha_t02.gat,231,161,5	script	ゲートガイド	874,{
	if(THA_1QUE) {
		...
		if(select("3層に行きたいのですが","契約者への説明を……")==2) {
			...
			next;
			mes "[プルレド]";
			mes "もし5人以上集まらなかった場合は、";
			mes "申し訳ありませんが、人数が揃うまで";
			mes "お待ちいただくことになります。";
			mes "だから、こちらにいらっしゃる際は";
			mes "なるべくお知り合いも";
			mes "連れて来てください。";
			close;
		}
		...
		mes strcharinfo(0)+ "様ですね。";
		next;
		if(getareausers("tha_t02.gat",226,156,236,166) >= 5) {
			mes "[プルレド]";
			mes "ちょうど人数が揃いましたので、";
			mes "3層へ通じるゲートを開きます。";
			next;
		...
		mes "[プルレド]";
		mes "現在の待機人数は、";
		mes getareausers("tha_t02.gat",226,156,236,166)+ "人ですね。";
		close;
	}
	mes "[プルレド]";
