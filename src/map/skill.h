...
#define skill_get_skilldb_id(id) \
	( ((id) >= 0 && (id) < MAX_SKILL) ? (id) : \
	  ...
	  ((id) >= HOM_SKILLID && (id) < MAX_HOM_SKILLID) ? ((id) - HOM_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_SJSKILL + MAX_SPSKILL + MAX_KOSKILL + MAX_EX3SKILL + MAX_SUMSKILL) : \
	  ((id) >= MERC_SKILLID && (id) < MAX_MERC_SKILLID) ? ((id) - MERC_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_SJSKILL + MAX_SPSKILL + MAX_KOSKILL + MAX_EX3SKILL + MAX_SUMSKILL + MAX_HOMSKILL) : \
	  ((id) >= ELEM_SKILLID && (id) < MAX_ELEM_SKILLID) ? ((id) - ELEM_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_SJSKILL + MAX_SPSKILL + MAX_KOSKILL + MAX_EX3SKILL + MAX_SUMSKILL + MAX_HOMSKILL + MAX_MERCSKILL) : \
	  ((id) >= GUILD_SKILLID && (id) < MAX_GUILD_SKILLID) ? ((id) - GUILD_SKILLID + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRDSKILL + MAX_QUESTSKILL + MAX_RLSKILL + MAX_SJSKILL + MAX_SPSKILL + MAX_KOSKILL + MAX_EX3SKILL + MAX_SUMSKILL + MAX_HOMSKILL + MAX_MERCSKILL + MAX_ELEMSKILL) : \
	  0 )
