...
#define skill_get_skilldb_id(id) \
	( ((id) >= 0               && (id) < MAX_SKILLID)         ? (id): \
	  ...
	  ((id) >= HOM_SKILLID     && (id) < MAX_HOM_SKILLID)     ? ((id) - HOM_SKILLID     + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRD1SKILL + MAX_THIRD2SKILL + MAX_THIRD3SKILL + MAX_THIRD4SKILL + MAX_FOURTH1SKILL + MAX_FOURTH2SKILL) : \
	  ((id) >= MERC_SKILLID    && (id) < MAX_MERC_SKILLID)    ? ((id) - MERC_SKILLID    + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRD1SKILL + MAX_THIRD2SKILL + MAX_THIRD3SKILL + MAX_THIRD4SKILL + MAX_FOURTH1SKILL + MAX_FOURTH2SKILL + MAX_HOMSKILL) : \
	  ((id) >= ELEM_SKILLID    && (id) < MAX_ELEM_SKILLID)    ? ((id) - ELEM_SKILLID    + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRD1SKILL + MAX_THIRD2SKILL + MAX_THIRD3SKILL + MAX_THIRD4SKILL + MAX_FOURTH1SKILL + MAX_FOURTH2SKILL + MAX_HOMSKILL + MAX_MERCSKILL) : \
	  ((id) >= ABR_SKILLID     && (id) < MAX_ABR_SKILLID)     ? ((id) - ABR_SKILLID     + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRD1SKILL + MAX_THIRD2SKILL + MAX_THIRD3SKILL + MAX_THIRD4SKILL + MAX_FOURTH1SKILL + MAX_FOURTH2SKILL + MAX_HOMSKILL + MAX_MERCSKILL + MAX_ELEMSKILL) : \
	  ((id) >= GUILD_SKILLID   && (id) < MAX_GUILD_SKILLID)   ? ((id) - GUILD_SKILLID   + MAX_SKILL + MAX_SECONDSKILL + MAX_THIRD1SKILL + MAX_THIRD2SKILL + MAX_THIRD3SKILL + MAX_THIRD4SKILL + MAX_FOURTH1SKILL + MAX_FOURTH2SKILL + MAX_HOMSKILL + MAX_MERCSKILL + MAX_ELEMSKILL + MAX_ABRSKILL) : \
	  0 )
